...
public class FontDrawable extends Drawable {
    ...
    public FontDrawable(Context context, int faIconRes, boolean isSolid, boolean isBrand) {
        super();
        init(context, null, faIconRes, isSolid, isBrand);
    }

    public FontDrawable(Context context, String faIconValue, boolean isSolid, boolean isBrand) {
        super();
        init(context, faIconValue, -1, isSolid, isBrand);
    }

    private void init(Context context, String faIconValue, int faIconRes, boolean isSolid, boolean isBrand) {
        ...
        if (faIconValue != null) {
            setText(Html.fromHtml(faIconValue));
        } else
