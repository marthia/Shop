...
public class AdaptiveTableLayout extends ViewGroup implements ScrollHelper.ScrollHelperListener, AdaptiveTableDataSetObserver {
    ...
    private int SHADOW_THICK = 20;
    private int SHADOW_HEADERS_THICK = 10;
    /**
    ...
    public void setShadowThick(int pixels) {
        this.SHADOW_THICK = pixels;
    }

    public int setShadowHeadersThick() {
        return SHADOW_HEADERS_THICK;
    }

    public void setShadowHeadersThick(int pixels) {
        this.SHADOW_HEADERS_THICK = pixels;
    }
